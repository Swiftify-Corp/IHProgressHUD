...
```ruby
pod 'IHProgressHUD', :git => 'https://github.com/Ibrahimhass/IHProgressHUD'
```
...
`IHProgressHUD` is brough to you by [Md Ibrahim Hassan](mdibrahimhassan@gmail.com) based on SVProgressHUD 
`SVProgressHUD` built by [Sam Vermette](http://samvermette.com), [Tobias Tiemerding](http://tiemerding.com) and [contributors to the project](https://github.com/SVProgressHUD/SVProgressHUD/contributors). If you're using `IHProgressHUD` in your project, attribution would be very appreciated.
